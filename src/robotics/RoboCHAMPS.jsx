  ...
  return (
    <div className="py-12 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:max-w-5xl md:mx-auto">
          <Card
            imgSrc={Skill}
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
      <div className="flex flex-col md:flex-row md:items-center">
        <div className="md:w-1/2 mb-4 md:mb-0">
          <img src={imgSrc} alt={alt} className="w-32 h-38 md:w-40 md:h-40 object-cover rounded-full mx-auto md:mx-0" />
        </div>
